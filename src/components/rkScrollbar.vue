...
const props = withDefaults(
  ...
  }>(),
  {
    reduce: 0,
    horizontal: false,
    mutationOpt: () => ({ subtree: true, childList: false, attributes: true }),
  },
)
const emit = defineEmits<{ (e: 'updated', data: typeof barData): void }>()
